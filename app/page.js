...
export default function Home() {
  ...
  // Effect to fetch inventory on component mount
  useEffect(() => {
    updateInventory()
  }, [])

  // Effect to filter inventory when search term changes
  useEffect(() => {
    handleSearch(search)
  }, [search, inventory])
  ...
  return (
    ...
    >
      ...
      <Box border="1px solid #333">
        <Box width="800px" height="100px" bgcolor="#a7e9ff" display="flex" alignItems="center" justifyContent="center">
